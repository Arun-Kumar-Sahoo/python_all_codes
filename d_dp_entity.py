import pandas as pd
df = pd.read_excel("C:\\Users\\arusahoo\\Desktop\\Model_Input_d_dp_entity.xlsx", dtype = str, sheet_name= "ConfigSheet")
df1 = pd.read_excel("C:\\Users\\arusahoo\\Desktop\\Model_Input_d_dp_entity.xlsx", dtype = str, sheet_name= "MappingSheet")
JSON_STRING = ""
